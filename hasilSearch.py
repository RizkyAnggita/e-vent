    ...
    def addButton(self, arrofEvent) : 
        ...
        for i in range(len(arrofEvent)) : 
            if (i == 0) :
                ...
                self.label1.setText(_translate("MainWindow", arrofEvent[i]))
            elif (i == 1) : 
                ...
                self.label2.setText(_translate("MainWindow", arrofEvent[i]))
            elif (i == 2) : 
                ...
                self.label3.setText(_translate("MainWindow", arrofEvent[i]))
            elif (i == 3) : 
                ...
                self.label4.setText(_translate("MainWindow", arrofEvent[i]))
            elif (i == 4) :
                ...
                self.label5.setText(_translate("MainWindow", arrofEvent[i]))
            elif (i == 5) : 
                ...
                self.label6.setText(_translate("MainWindow", arrofEvent[i]))
            elif (i == 6) :
                ...
                self.label7.setText(_translate("MainWindow", arrofEvent[i]))
            elif (i == 7) : 
                ...
                self.label8.setText(_translate("MainWindow", arrofEvent[i]))
